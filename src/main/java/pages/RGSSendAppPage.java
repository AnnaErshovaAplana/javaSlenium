...
public class RGSSendAppPage extends RGSBasePage {
    ...
    @FindBy(xpath = "//input[contains(@data-bind,'ContactDate')]")
    ...
    public RGSSendAppPage(WebDriver driver) {
    ...
    public void fillFields(String fieldName, String value) {
        switch (fieldName) {
            ...
            case "Телефон":
                ...
                break;
            case "Регион":
                new Select(region).selectByVisibleText(value);
                break;
            case "Эл. почта":
